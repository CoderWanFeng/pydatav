"""
python-pydatav Command Line Interface
====================================

```script
python -m pydatav --help
```
"""
from typer import Typer

app = Typer(name="python-pydatav CLI")
...
#     try:
#         from pydatav.ppt import ppt2pdf
#     except ImportError:
#         from pydatav.ppt import ppt2pdf
...
def docx2pdf(dir_path: str, suffix="docx"):
    """docx转pdf"""
    from pydatav.word import docx2pdf
